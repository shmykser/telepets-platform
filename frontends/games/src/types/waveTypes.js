 ...
 */
export const WAVE_ENEMY_TYPES = {
    1: ['slug'],
    5: ['ant', 'beetle'],
    4: ['ant', 'fly', 'mosquito', 'flea', 'bee', 'wasp'],
    3: ['dragonfly'],
...
export const WAVE_SETTINGS = {
    duration: 1 * 60 * 1000,        // 10 минут в миллисекундах
    waveDuration: 1 * 60 * 1000,          // 30 секунд в миллисекундах
    startWave: 1 // волна, с которой начинается игра
};
